...
$(".guardarHabitacion").click(function(){
	...
	if(tipo == "" || tipo_h == ""){
	    ...
	    swal({
	        title: "Error al guardar",
	        text: "El campo 'Nombre de espacio' no puede ir vacío",
	        type: "error",
	        confirmButtonText: "¡Cerrar!"
	      });
	      	...
	      	success:function(respuesta){
      			...
      			if(respuesta == "ok"){
      				...
      				swal({
		                type:"success",
		                  title: "¡CORRECTO!",
		                  text: "¡El espacio ha sido guardada exitosamente!",
...
$(document).on("click", ".eliminarHabitacion", function(){
  ...
  swal({
    ...
    confirmButtonText: 'Si, eliminar Espacio!'
  }).then(function(result){
          ...
          success:function(respuesta){
             ...
             if(respuesta == "ok"){
               swal({
                  type: "success",
                  title: "¡CORRECTO!",
                  text: "El espacio ha sido borrada correctamente",
                  showConfirmButton: true,
                  confirmButtonText: "Cerrar"
                 }).then(function(result){
