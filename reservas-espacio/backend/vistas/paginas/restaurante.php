      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Arsenal</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card card-primary card-outline">
       ...
       <div class="card-header pl-2 pl-sm-3">
        ...
        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#crearRestaurante">Crear nuevo plato de arsenal</button>
