		...
		<div class="grid-container py-2">
			...
			<div class="grid-item">
				...
				<a href="<?php echo $ruta;  ?>">
					...
					<img src="img/logolabase.png" class="img-fluid">
					...
					<div class="formReservas py-1 py-lg-2 px-4">
						...
						<div class="form-group my-4">
							<select class="form-control form-control-lg selectTemaHabitacion" name="id-habitacion" required>
								...
								<option value="">Temática de espacio</option>
...
<nav class="menu container-fluid p-0">
	...
	<ul class="nav nav-justified py-2">
		...
		<li class="nav-item">
			<a class="nav-link text-white" href="#habitaciones">Espacios</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white" href="#pueblo">La Base</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white" href="#restaurante">Arsenal</a>
		</li>
...
<div class="menuMovil">
	...
	<ul class="nav flex-column mt-4 pl-4 mb-5">
		...
		<li class="nav-item">
			<a class="nav-link text-white my-2" href="#habitaciones">Espacios</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white my-2" href="#pueblo">Recorrido por la Base</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white my-2" href="#restaurante">Arsenal</a>
		</li>
