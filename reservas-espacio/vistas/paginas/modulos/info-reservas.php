		...
		<div class="row">
			...
			<div class="col-12 col-lg-4 colDerReservas" style="display:none">
				...
				<div class="form-group">
				  <label>Ingreso 8:00 pm:</label>
				  <input type="text" class="form-control" value="<?php echo $_POST["fecha-ingreso"];?>" readonly>
				</div>

				<div class="form-group">
				  <label>Salida 7:00 pm:</label>
				  <input type="text" class="form-control" value="<?php echo $_POST["fecha-salida"];?>"  readonly>
				</div>

				<div class="form-group">
				  <label>Espacios:</label>
			<input type="text" class="form-control" value="Tipo <?php echo $reservas[$indice]["tipo"]." ".$reservas[$indice]["estilo"]; ?>" readonly>
				...
				<div class="form-group">
				  ...
				  <select class="form-control elegirPlan">
					...
					<option value="<?php echo $precioContinental;?>,Plan Especial">Plan Basico S/<?php echo number_format($precioContinental); ?></option>
					<option value="<?php echo $precioAmericano;?>,Plan Basico">Plan Especial S/<?php echo number_format($precioAmericano); ?></option> 
				  </select>
				</div>
				...
				<div class="row py-4">
					...
					<div class="col-12 col-lg-6 col-xl-7 text-center text-lg-left">
						...
						<h1 class="precioReserva">S/<span><?php echo number_format($precioContinental*$dias);?></span> PEN</h1>
					...
					<?php if (isset($_SESSION["validarSesion"])): ?>
						...
						<?php if ($_SESSION["validarSesion"] == "ok"): ?>
							...
							<a href="<?php echo $ruta;?>perfil" 
								...
								infoHabitacion="Tipo <?php echo $reservas[$indice]["tipo"]." ".$reservas[$indice]["estilo"]; ?>"
	 ...
	 <div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
	        	<h4 class="modal-title text-uppercase">Espacio <?php echo $reservas[$indice]["tipo"].' '.$reservas[$indice]["estilo"]; ?></h4>
       			...
       			<?php foreach ($planes as $key => $value): ?>
					...
					<div class="col-12 col-md-6">
						...
						<figure class="center">
	       				...
	       				<h4 class="px-2">Precio por persona</h4>
